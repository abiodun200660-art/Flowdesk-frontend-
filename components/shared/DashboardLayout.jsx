...
// FIX: SidebarContent moved OUTSIDE DashboardLayout so React doesn't
// create a new component type on every render (caused React error #31)
function SidebarContent({ user, pathname, logout, onClose, isActive }) {
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2.5 px-4 h-14 border-b border-surface-200 dark:border-surface-800 flex-shrink-0">
        ...
        <button className="ml-auto md:hidden text-gray-400" onClick={onClose}>
          <X size={18} />
        </button>
      </div>
